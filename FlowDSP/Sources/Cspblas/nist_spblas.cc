...
class TSp_mat : public Sp_mat
{
  private:
    ...
    vector<T> diag;
    /* optional diag if matrix is triangular. Created at end_construction() phase */
  private:
 ...
 public:
  ...
  inline bool get( int i, int j, float* result, int* colIndex ) {
      if (S.size() <= i || S[i].size() <= j) {
          return false;
      }

      *result = val(S[i][j]);
      *colIndex = col_index(S[i][j]);
      return true;
  }
...
template <class T>
bool BLAS_xuscr_get_entry(blas_sparse_matrix A, int i, int j, float* result, int* colIndex)
{
    TSp_mat<T> *M = (TSp_mat<T> *) Table[A];
    ASSERT_RETURN(M->is_valid(), 1);
    return M->get(i, j, result, colIndex);
}
...
/*********/
 ...
 extern "C" void sparse_usdot_double(
    int  nz,
    ...
    enum blas_base_type index_base)
{
 ...
 extern "C" void sparse_usaxpy_double(
    int nz,
    ...
    enum blas_base_type index_base)
{
 ...
 extern "C" void sparse_usga_double(
    int nz,
    SPBLAS_VECTOR_DOUBLE_IN y,
    int incy,
    ...
    enum blas_base_type index_base )
{
 ...
 extern "C" void sparse_usgz_double(
    int nz,
    SPBLAS_VECTOR_DOUBLE_IN_OUT y,
    int incy,
    ...
    enum blas_base_type index_base )
{
 ...
 extern "C" void sparse_ussc_double(
    int nz,
    SPBLAS_VECTOR_DOUBLE_IN x,
    SPBLAS_VECTOR_DOUBLE_IN_OUT y,
    int incy,
...
extern "C" int sparse_uscr_begin_double(int M, int N)
{
...
extern "C" blas_sparse_matrix sparse_uscr_block_begin_double(
...
extern "C" blas_sparse_matrix sparse_uscr_variable_block_begin_double(
...
extern "C" int sparse_uscr_insert_col_double(
...
extern "C" int sparse_uscr_insert_row_double(
  blas_sparse_matrix A, int i, int nz,
  SPBLAS_VECTOR_DOUBLE_IN val, const int *indx );

extern "C" int sparse_uscr_insert_clique_double(
...
extern "C" int sparse_uscr_insert_block_double(
    blas_sparse_matrix A,
    SPBLAS_VECTOR_DOUBLE_IN val,
    int row_stride,
    int col_stride,
...
extern "C" int sparse_uscr_end_double(blas_sparse_matrix A)
{
...
/*  DOUBLE Level 2/3 computational routines */
 ...
 extern "C" int sparse_usmv_double(enum
...
extern "C" int sparse_usmm_double(
...
extern "C" int sparse_ussv_double(
    enum blas_trans_type transa,
    SPBLAS_DOUBLE_IN alpha,
    blas_sparse_matrix A,
    SPBLAS_VECTOR_DOUBLE_IN_OUT x,
...
extern "C" int sparse_ussm_double(
    enum blas_order_type order,
...
/*********/
 ...
 extern "C" void sparse_usdot_float(
    int  nz,
    ...
    enum blas_base_type index_base)
{
 ...
 extern "C" void sparse_usaxpy_float(
    int nz,
    ...
    enum blas_base_type index_base)
{
 ...
 extern "C" void sparse_usga_float(
    int nz,
    SPBLAS_VECTOR_FLOAT_IN y,
    int incy,
    ...
    enum blas_base_type index_base )
{
 ...
 extern "C" void sparse_usgz_float(
    int nz,
    SPBLAS_VECTOR_FLOAT_IN_OUT y,
    int incy,
    ...
    enum blas_base_type index_base )
{
 ...
 extern "C" void sparse_ussc_float(
    int nz,
    SPBLAS_VECTOR_FLOAT_IN x,
    SPBLAS_VECTOR_FLOAT_IN_OUT y,
    int incy,
...
extern "C" int sparse_uscr_begin_float(int M, int N)
{
...
extern "C" blas_sparse_matrix sparse_uscr_block_begin_float(
    int Mb, int Nb, int k, int l )
{
...
extern "C" blas_sparse_matrix sparse_uscr_variable_block_begin_float(
    int Mb, int Nb, const int *k, const int *l )
{
...
extern "C" int sparse_get_entry_float( blas_sparse_matrix A, int i, int j, float* result, int* colIndex )
{
    return (int) BLAS_xuscr_get_entry<float>(A, i, j, result, colIndex);
}

extern "C" int sparse_uscr_insert_entry_float(
    blas_sparse_matrix A, SPBLAS_FLOAT_IN val, int i, int j )
{
    return BLAS_xuscr_insert_entry(A, SPBLAS_TO_FLOAT_IN( val ), i, j);
}

extern "C" int sparse_uscr_insert_entries_float(
    blas_sparse_matrix A, int nz,
...
extern "C" int sparse_uscr_insert_col_float(
    blas_sparse_matrix A, int j, int nz,
...
extern "C" int sparse_uscr_insert_row_float(
  blas_sparse_matrix A, int i, int nz,
  SPBLAS_VECTOR_FLOAT_IN val, const int *indx );

extern "C" int sparse_uscr_insert_clique_float(
    blas_sparse_matrix A,
    const int k,
    const int l,
    SPBLAS_VECTOR_FLOAT_IN val,
...
extern "C" int sparse_uscr_insert_block_float(
    blas_sparse_matrix A,
    SPBLAS_VECTOR_FLOAT_IN val,
    int row_stride,
    int col_stride,
...
extern "C" int sparse_uscr_end_float(blas_sparse_matrix A)
{
  return BLAS_xuscr_end(A);
}
...
/*  FLOAT Level 2/3 computational routines */
 ...
 extern "C" int sparse_usmv_float(enum
    blas_trans_type transa,
    SPBLAS_FLOAT_IN alpha,
    blas_sparse_matrix A,
    SPBLAS_VECTOR_FLOAT_IN x,
...
extern "C" int sparse_usmm_float(
    enum blas_order_type order,
    enum blas_trans_type transa,
    int nrhs,
    SPBLAS_FLOAT_IN alpha,
...
extern "C" int sparse_ussv_float(
    enum blas_trans_type transa,
    SPBLAS_FLOAT_IN alpha,
    blas_sparse_matrix A,
    SPBLAS_VECTOR_FLOAT_IN_OUT x,
...
extern "C" int sparse_ussm_float(
    enum blas_order_type order,
    enum blas_trans_type transt,
    int nrhs,
    SPBLAS_FLOAT_IN alpha,
